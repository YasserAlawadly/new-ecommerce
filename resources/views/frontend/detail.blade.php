                    ...
                    <div class="row m-sm-0">
                        ...
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block"
                                    ...
                                    class="d-block" href="{{ asset('frontend/img/product-detail-2.jpg') }}" data-lightbox="product"
                                    title="Product item 2"><img class="img-fluid" src="{{ asset('frontend/img/product-detail-2.jpg') }}"
                                        ...
                                        class="img-fluid" src="{{ asset('frontend/img/product-detail-3.jpg') }}" alt="..."></a><a
                                    class="d-block" href="{{ asset('frontend/img/product-detail-4.jpg') }}" data-lightbox="product"
                                    title="Product item 4"><img class="img-fluid" src="{{ asset('frontend/img/product-detail-4.jpg') }}"
                                                                alt="..."></a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-content mb-5" id="myTabContent">
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                    <div class="p-4 p-lg-5 bg-white">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="media mb-3"><img class="rounded-circle" src="{{ asset('frontend/img/customer-1.png') }}" alt=""
                                                             width="50">
